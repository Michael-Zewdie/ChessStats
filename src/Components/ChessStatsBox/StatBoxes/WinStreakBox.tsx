...
export default function WinStreakBox({ games }: WinStreakBoxProps) {
  ...
  return (
    ...
    >
      ...
      {showDescription && (
        ...
        >
          <div style={{ 
            ...
            🔥 Win Streak Stat Explained
          </div>
          <div style={{ fontSize: '0.9rem', color: '#e5e7eb', marginBottom: '1rem' }}>Your <strong>longest win streak</strong> shows the maximum consecutive wins you've achieved chronologically across all game types.</div>
          <div style={{ fontSize: '0.85rem', color: '#d1d5db', marginBottom: '0.75rem' }}><strong>How it's calculated:</strong></div>
          <div style={{ fontSize: '0.8rem', color: '#9ca3af', marginBottom: '1rem', paddingLeft: '1rem' }}>• Counts consecutive wins in chronological order<br/>• Works across all time controls and game types<br/>• Tracks your longest streak ever achieved</div>
          <button
            style={{
      ...
      <div style={{ fontSize: '0.75rem', color: '#9ca3af', marginBottom: '0.25rem' }}>Win Streak</div>
