...
export default function VictimBox({ games }: VictimBoxProps) {
  ...
  return (
    ...
    >
      ...
      {showDescription && (
        ...
        >
          <div style={{ 
            ...
            🎯 Victim Stat Explained
          </div>
          <div style={{ fontSize: '0.9rem', color: '#e5e7eb', marginBottom: '1rem' }}>Your <strong>victim</strong> is the opponent you've beaten the most (minimum 2 wins required).</div>
          <div style={{ fontSize: '0.85rem', color: '#d1d5db', marginBottom: '0.75rem' }}><strong>How it's calculated:</strong></div>
          <div style={{ fontSize: '0.8rem', color: '#9ca3af', marginBottom: '1rem', paddingLeft: '1rem' }}>• Counts wins against each opponent<br/>• Finds the player you've beaten most often<br/>• Requires at least 2 wins to qualify as victim</div>
          <button
            style={{
      ...
      <div style={{ fontSize: '0.75rem', color: '#9ca3af', marginBottom: '0.25rem' }}>Victim</div>
