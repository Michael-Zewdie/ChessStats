      ...
      {showDescription && (
        ...
        >
          <div style={{ 
            ...
            😈 Nemesis Stat Explained
          </div>
          <div style={{ fontSize: '0.9rem', color: '#e5e7eb', marginBottom: '1rem' }}>Your <strong>nemesis</strong> is the opponent you've lost to the most (minimum 2 losses required).</div>
          <div style={{ fontSize: '0.85rem', color: '#d1d5db', marginBottom: '0.75rem' }}><strong>How it's calculated:</strong></div>
          <div style={{ fontSize: '0.8rem', color: '#9ca3af', marginBottom: '1rem', paddingLeft: '1rem' }}>• Counts losses against each opponent<br/>• Finds the player who has beaten you most often<br/>• Requires at least 2 losses to qualify as nemesis</div>
          <button
            style={{
