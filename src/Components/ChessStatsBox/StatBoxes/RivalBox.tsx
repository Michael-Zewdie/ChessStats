      ...
      {showDescription && (
        ...
        >
          <div style={{ 
            ...
            ⚔️ Rival Stat Explained
          </div>
          <div style={{ fontSize: '0.9rem', color: '#e5e7eb', marginBottom: '1rem' }}>
            Your <strong>rival</strong> is the opponent you've played against the most frequently (minimum 3 games required).
          </div>
          <div style={{ fontSize: '0.85rem', color: '#d1d5db', marginBottom: '0.75rem' }}>
            <strong>How it's calculated:</strong>
          </div>
          <div style={{ fontSize: '0.8rem', color: '#9ca3af', marginBottom: '1rem', paddingLeft: '1rem' }}>
            • Counts total games played against each opponent<br/>
            • Requires minimum 3 games to qualify as a rival<br/>
            • Shows the opponent with the highest game count
          </div>
          <button
            style={{
        ...
        >
          ...
          {rivalStats.rival ? (
            <div style={{
              ...
              <span style={{ fontWeight: '500', color: '#e5e7eb' }}>{rivalStats.rival}</span>
              <span style={{ 
                marginLeft: '0.5rem',
                color: '#9ca3af',
                fontSize: '0.7rem'
