...
export default function DedicationBox({ games }: DedicationBoxProps) {
  ...
  return (
    ...
    >
      ...
      {showDescription && (
        ...
        >
          <div style={{ 
            ...
            💪 Dedication Stat Explained
          </div>
          <div style={{ fontSize: '0.9rem', color: '#e5e7eb', marginBottom: '1rem' }}>Your <strong>dedication score</strong> shows the most games you've ever played in a single day.</div>
          <div style={{ fontSize: '0.85rem', color: '#d1d5db', marginBottom: '0.75rem' }}><strong>How it's calculated:</strong></div>
          <div style={{ fontSize: '0.8rem', color: '#9ca3af', marginBottom: '1rem', paddingLeft: '1rem' }}>• Groups all games by date<br/>• Counts games played on each day<br/>• Shows your highest single-day game count</div>
          <button
            style={{
      ...
      <div style={{ fontSize: '0.75rem', color: '#9ca3af', marginBottom: '0.25rem' }}>Dedication</div>
